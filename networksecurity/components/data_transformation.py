...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        ...
        Returns:
            A pipeline Object
        """
        logging.info("Entered get_data_transformaer_object method of Transformation class")
        try:
    ...
    def initiate_data_tranformation(self)->DataTransformationArtifact:
        logging.info("Enterd initiate_data_tranformation method of DataTransformation class")
        try:
            logging.info("Startinf data transformation")
